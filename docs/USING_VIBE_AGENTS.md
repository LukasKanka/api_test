...
- [Vibe Code](https://mistral.ai/products/vibe/code) – Stránka produktu Vibe Code
- [Vibe CLI GitHub](https://github.com/mistralai/vibe) – Repozitář Vibe CLI

### Bruno
- [Bruno Web](https://www.usebruno.com/) – Hlavní stránka
...
- [JSONPlaceholder](https://jsonplaceholder.typicode.com/) – Veřejné API pro testování
- [OpenWeather API](https://openweathermap.org/api) – Příklad veřejného API
